...
class AppointmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'appointment_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'patient_id' => 1,
                'doctor_id' => 1,
                'appointment_date' => '2018-11-07 14:03:04',
                'created' => '2018-11-07 14:03:04',
                'modified' => '2018-11-07 14:03:04'
            ],
        ];
        parent::init();
    }
