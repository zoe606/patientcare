...
class CarriersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'carrier_code' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => '0', 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-07 14:02:40',
                'modified' => '2018-11-07 14:02:40'
            ],
        ];
        parent::init();
    }
